import FbTeam from "../IconComponents/FbTeam";
import InstaTeam from "../IconComponents/InstaTeam";
import XTeam from "../IconComponents/XTeam";
import TeamCardData from "./TeamCardData";
    ...
    function TeamCard(){
        ...
        return (
            <>
            {TeamCardData.map((value,index) => (
           <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4" key={index}>
